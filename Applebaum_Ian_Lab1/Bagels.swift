...
class Bagels {
	...
	*/
	...
	fileprivate func checkFirstGuess(_ guess: Bagels.number, _ randomNumber: Bagels.number, _ result: inout String) ->Bool {
...
//			result.append("BAGELS")
	...
	///   - randomNumber: number generated by the computer
	///   - result: Either FERMI when you guessed right! PICO if the number is right but hte wrong order. BAGELS you guessed wrong!
	fileprivate func checkSecondGuess(_ guess: Bagels.number, _ randomNumber: Bagels.number, _ result: inout String) -> Bool{
		switch guess.second {
		case randomNumber.second:
			result.append(" FERMI")
			return true
...
//			result.append(" BAGELS")
	...
	///   - randomNumber: number generated by the computer
	///   - result: Either FERMI when you guessed right! PICO if the number is right but hte wrong order. BAGELS you guessed wrong!
	fileprivate func checkBAGELGuess(_ guess: Bagels.number, _ randomNumber: Bagels.number, _ result: inout String)->Bool {
		switch guess.Third {
		case randomNumber.Third:
			result.append(" FERMI")
			return true
...
//			result.append(" BAGELS")
	...
	fileprivate func checkThirdGuess(_ guess: Bagels.number, _ randomNumber: Bagels.number, _ result: inout String) -> Bool{
			switch guess.Third {
			case randomNumber.Third:
				result.append(" FERMI")
				return true
	...
	*/
	public func playGame(){
		...
		repeat{
			...
			if firstGuess == false && secondGuess == false && thirdGuess == false {
				result.append("BAGELS")
			}
			print(result)
